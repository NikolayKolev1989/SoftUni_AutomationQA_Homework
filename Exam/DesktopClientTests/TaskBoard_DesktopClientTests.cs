...
{
    public class TaskBoard_DesktopClientTests
    {

        private const string AppiumUrl = "http://127.0.0.1:4723/wd/hub";
        private const string tasksUrl = "https://taskboard.nakov.repl.co";
        private const string appLocation = @"C:\TaskBoard.DesktopClient\TaskBoard.DesktopClient.exe";
