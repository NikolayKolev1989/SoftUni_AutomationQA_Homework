...
namespace Collections_Test
{
    public class CollectionsTests
    {
        ...
        {
            // Arrange
            var objects = new Collection<object>(1, "Kolio", 100);

            // Assert
            Assert.That(objects.ToString(), Is.EqualTo("[1, Kolio, 100]"));
        }
        ...
        {
            // Arrange
            var names = new Collection<string>("Kolio");

            // Assert
            Assert.That(names.ToString(), Is.EqualTo("[Kolio]"));
        }
    }
}